...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <h1>Processing Category Creation</h1>
        </div>
        ...
        String categoryDescription = request.getParameter("categoryDescription");
            ...
            // Handle file upload
            Part filePart = request.getPart("categoryImage");  // Get the uploaded file
            if (filePart != null) {
                ...
                Category newCategory = new Category(categoryName, categoryDescription, "img/" + fileName);
