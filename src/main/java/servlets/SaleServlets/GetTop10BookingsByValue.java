...
@WebServlet("/GetTop10BookingsByValue")
public class GetTop10BookingsByValue extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String apiUrl = "http://localhost:8081/ca2-ws/getTop10BookingsByValue";
